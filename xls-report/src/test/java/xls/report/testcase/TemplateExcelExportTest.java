...
public class TemplateExcelExportTest {
    ...
    public void test() throws Exception {
        ...
        FileOutputStream fos = new FileOutputStream("l:/opt/excel/专项支出用款申请书.xls");
        workbook.write(fos);
        fos.close();
        System.out.print("l:/opt/excel/专项支出用款申请书.xls");
    }

    @Test
    public void fe_map() throws Exception {
        TemplateExportParams params = new TemplateExportParams(
                "doc/专项支出用款申请书_map.xls");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("date", "2014-12-25");
        map.put("money", 2000000.00);
        map.put("upperMoney", "贰佰万");
        ...
        FileOutputStream fos = new FileOutputStream("l:/opt/excel/专项支出用款申请书_map.xls");
        workbook.write(fos);
        fos.close();
        System.out.print("l:/opt/excel/专项支出用款申请书_map.xls");
    }
    ...
    public void test2() throws Exception {
        ...
        map.put("list", list);
        Workbook workbook = ExcelExportUtil.exportExcel(params, map);
        File savefile = new File("l:/home/excel/");
        if (!savefile.exists()) {
            savefile.mkdirs();
        }
        FileOutputStream fos = new FileOutputStream("l:/home/excel/merge_test.xls");
        workbook.write(fos);
        fos.close();
    }

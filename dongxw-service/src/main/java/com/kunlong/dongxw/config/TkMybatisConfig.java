...
//        scan.setSqlSessionFactoryBeanName("dongxwSqlSessionFactory"); // 多数据源时，必须配置
//        scan.setBasePackage("com.kunlong.dongxw.data.dao");//mapper.java文件的路径
//        scan.setMarkerInterface(BaseMapper.class); // 直接继承了BaseMapper接口的才会被扫描，basePackage可以配置的范围更大。

...
public class MakeSheet extends MakeSheetBase implements Serializable {
    ...
    public static class EntityNode extends AbstractEntityNode<MakeSheet> {
    	...
    	/** 物料标识  */
        public FieldNode<MakeSheet, Integer> rmId =  createFieldNode("rmId","rm_id",Integer.class,JdbcType.INTEGER);
    	/** 父件标识  */
    	...
    	/** 每个用量  */
        public FieldNode<MakeSheet, BigDecimal> pQty =  createFieldNode("pQty","p_qty",BigDecimal.class,JdbcType.DECIMAL);
    	/** 用量  */
